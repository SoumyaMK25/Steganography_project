...
{
    /* Source Image info */
    char *src_image_fname;   //collect the file 
    FILE *fptr_src_image;
    char image_data[MAX_IMAGE_BUF_SIZE];  // it contains the

    /* Secret File Info */
    char *secret_fname;  //this string is to be pass
    FILE *fptr_secret;
...
OperationType check_operation_type(char *argv[]);    //check encode or decode
...
/* Encode a byte into LSB of size of image data array */
